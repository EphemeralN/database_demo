...
def lookup_records():
    ...
    search.title("Lookup Requirements")
    search.geometry("400x200")
    search.iconbitmap('D:\Henglong.ico')

    # Create label frame
    search_frame = LabelFrame(search, text="Project")
    ...
    # Add button
    search_button = Button(search, text="Search Requirement", command=search_records)
...
# Define Our Columns
my_tree['columns'] = ("OEM", "Project", "Safety Goal ID", "Safety Goal", "ASIL Level", "FTTI", "Functional Safety (FSR)")

# Format Our Columns
my_tree.column("#0", width=0, stretch=NO)
my_tree.column("OEM", anchor=W, width=140)
my_tree.column("Project", anchor=W, width=140)
my_tree.column("Safety Goal ID", anchor=CENTER, width=100)
my_tree.column("Safety Goal", anchor=CENTER, width=140)
my_tree.column("ASIL Level", anchor=CENTER, width=140)
my_tree.column("FTTI", anchor=CENTER, width=140)
my_tree.column("Functional Safety (FSR)", anchor=CENTER, width=140)

# Create Headings
my_tree.heading("#0", text="", anchor=W)
my_tree.heading("OEM", text="OEM", anchor=W)
my_tree.heading("Project", text="Project", anchor=W)
my_tree.heading("Safety Goal ID", text="Safety Goal ID", anchor=CENTER)
my_tree.heading("Safety Goal", text="Safety Goal", anchor=CENTER)
my_tree.heading("ASIL Level", text="ASIL Level", anchor=CENTER)
my_tree.heading("FTTI", text="FTTI", anchor=CENTER)
my_tree.heading("Functional Safety (FSR)", text="Functional Safety (FSR)", anchor=CENTER)
...
fn_label = Label(data_frame, text="OEM")
fn_label.grid(row=0, column=0, padx=10, pady=10)
fn_entry = Entry(data_frame)
fn_entry.grid(row=0, column=1, padx=10, pady=10)

ln_label = Label(data_frame, text="Project")
ln_label.grid(row=0, column=2, padx=10, pady=10)
ln_entry = Entry(data_frame)
ln_entry.grid(row=0, column=3, padx=10, pady=10)

id_label = Label(data_frame, text="Safety Goal ID")
id_label.grid(row=0, column=4, padx=10, pady=10)
id_entry = Entry(data_frame)
id_entry.grid(row=0, column=5, padx=10, pady=10)

address_label = Label(data_frame, text="Safety Goal")
address_label.grid(row=1, column=0, padx=10, pady=10)
address_entry = Entry(data_frame)
address_entry.grid(row=1, column=1, padx=10, pady=10)

city_label = Label(data_frame, text="ASIL Level")
city_label.grid(row=1, column=2, padx=10, pady=10)
city_entry = Entry(data_frame)
city_entry.grid(row=1, column=3, padx=10, pady=10)

state_label = Label(data_frame, text="FTTI")
...
zipcode_label = Label(data_frame, text="Functional Safety (FSR)")
...
update_button = Button(button_frame, text="Update Requirement", command=update_record)
update_button.grid(row=0, column=0, padx=10, pady=10)

add_button = Button(button_frame, text="Add Requirement", command=add_record)
add_button.grid(row=0, column=1, padx=10, pady=10)

remove_all_button = Button(button_frame, text="Remove All Requirements", command=remove_all)
